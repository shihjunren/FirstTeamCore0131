    ...
    public class SetController : Controller
    {
        ...
        public IActionResult SetOrder(CKeywordViewModel vm)
        {
            ...
            else
            {
                ...
                t.評論.Contains(vm.txtKeyword) || t.合計總價.Equals(vm.txtKeyword) || t.入住時間.Equals(vm.txtKeyword) || t.退住時間.Equals(vm.txtKeyword) || t.預計天數.Equals(vm.txtKeyword) || t.預計人數.Equals(vm.txtKeyword));
            }
            return View(datas);
        }
        ...
        public IActionResult SetDetail(CKeywordViewModel vm)
        {
            ...
            else
            {
                ...
                t.套裝細項.Contains(vm.txtKeyword) || t.露營天數.Equals(vm.txtKeyword) || t.套裝行程價格.Equals(vm.txtKeyword) );
            }
            return View(datas);
        }
